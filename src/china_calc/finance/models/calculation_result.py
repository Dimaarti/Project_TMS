...
class CalculationResult(BaseModel):
    ...
    base_currency = models.CharField(
        max_length=3, default="CNY", verbose_name="Валюта базовая"
    )
    ...
    price_cost = models.DecimalField(
        max_digits=16, decimal_places=2, default=0, verbose_name="Расчет себестоимости"
    )

    client_price_cost = models.DecimalField(
        max_digits=16, decimal_places=2, default=0, verbose_name="Итого для клиента"
    )
