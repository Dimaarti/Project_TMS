...
from china_calc.finance.calculators.shipment_expense_calculator import ShipmentExpenseCalculator
from config.model_choices import LogisticCalculationMethod, Currency
...
class TestShipmentExpenseCalculator(TestCase):
    ...
    def test_rejects_expense_for_item_from_another_shipment(self):
        ...
        with self.assertRaisesRegex(
            ValueError,
            "Товар расхода не принадлежит этой поставке"
        ):
            ShipmentExpenseCalculator.calculate(shipment=shipment)
